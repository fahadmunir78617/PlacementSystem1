	...
	<div class="mainpage">
        <div class="hd_title">Applied Jobs</div>
            <div class="main" style="padding-bottom: 520px">
                            ...
                            {
                                $email = $_SESSION['employeremail'];
                            }

                            $employerid = $_SESSION['userid'];

                            $sql = "SELECT * FROM appliedjob WHERE empid = '$employerid' ORDER BY FIELD(status,'Pending',status)";
...
<br>
                                            <button class="btn btn-danger"  style="margin-left: 250px"><a href='../pdf/<?php echo $row['cv'] ?>' ><span style="color: white">download cv</span></a></button>
									</div>
									</div>
									</div>
