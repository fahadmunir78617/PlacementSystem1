    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") 
    {
        ...
        else
        {
            if(isset($_POST['password']) && isset($_POST['email']) && $_POST['password']!="" && $_POST['email']!="" )
            {
                ...
                $sql="INSERT INTO student (fname,lname,email,password,address,city,contact,qualification,stream,skills,about,state,cv)"
            . "VALUES ('$fname','$lname','$email','$password','$address','$city','$contact','$qualification','$stream','$skills','$about','$state','$upload_pdf')";
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="font"  required   class="form-control input-sm" name="pdf_file"  accept="application/pdf">
